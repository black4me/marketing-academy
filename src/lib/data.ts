...
export const TEMPLATES: Template[] = [
  {
    ...
    body: `# نموذج صفحة هبوط عالية التحويل
...
- زر واضح + ضمان استرداد + ندرة حقيقية.`,
  },
  {
    ...
    body: `# تقويم محتوى أسبوعي (Hook → Value → CTA)
...
`,
  },
  {
    ...
    body: `# سلسلة ترحيبية من 5 رسائل (Welcome Sequence)
...
- المحتوى: العرض + سعر + ندرة + CTA واحد.`,
  },
  {
    ...
    body: `# هيكل حملة Meta Ads (Campaign → Ad Set → Ad)
...
export const MODULES: Module[] = [
  {
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "العاطفة أولاً، المنطق ثانياً", body: "كل قرار شرائي يبدأ عاطفياً ثم يبرَّر منطقياً. مهمتك كمسوّق هي إثارة المشاعر الصحيحة (الأمان، الانتماء، الإنجاز، الهوية) ثم تزويد العقل بالأدلة (الأرقام، الشهادات، الضمانات)." },
          { heading: "محرّكات الشراء السبعة", body: "هذه هي المحرّكات النفسية الأساسية التي تقف خلف 95% من قرارات الشراء:", bullets: ["تجنّب الألم (أقوى من السعي للمتعة بـ 2.5 ضعف)","السعي للمتعة والمكافأة الفورية","الانتماء وتأكيد الهوية الاجتماعية","الندرة والخوف من الفوات (FOMO)","السلطة والثقة في الخبير","المعاملة بالمثل (Reciprocity)","الالتزام والاتساق"] },
          { heading: "نموذج Jobs-to-be-Done", body: "العميل لا يشتري المنتج، بل يستأجره لإنجاز مهمة. الفِرَنشي لا يشتري دريلاً، بل ثقباً في الجدار. اسأل دائماً: ما المهمة التي يحاول العميل إنجازها؟" },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "الاعتراضات الستة الكلاسيكية", body: "عندما لا يشتري عميل، فهو يقول لنفسه واحدة من ست جمل:", bullets: ["لا أحتاجه (قيمة غير واضحة)","لا أثق بك (انعدام Social Proof)","لا أملك المال (سعر غير مبرَّر مقابل القيمة)","لن ينجح معي (هويتي مختلفة)","ليس الوقت المناسب (لا توجد ندرة حقيقية)","أحتاج التفكير (لا يوجد CTA واضح أو ضمان)"] },
          { heading: "إطار حلّ الاعتراضات في المحتوى", body: "ابنِ مكتبة محتوى تحطّم اعتراضاً لكل قطعة. منشور لكل اعتراض، فيديو لكل اعتراض، إيميل لكل اعتراض. هكذا يصل العميل لصفحة الدفع بدون مقاومة." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "معادلة القيمة", body: "القيمة المُدرَكة = (النتيجة المرغوبة × احتمال النجاح) ÷ (الوقت × الجهد). كلما رفعت البَسط وخفّضت المقام، ارتفعت قيمة عرضك بدون رفع السعر." },
          { heading: "مرساة السعر (Price Anchoring)", body: "اعرض الباقة الأغلى أولاً، ثم الموصى بها، ثم الأرخص. الدماغ سيستخدم الأولى كمرجع، فتبدو الموصى بها 'صفقة'." },
          { heading: "Stack القيمة", body: "بدلاً من بيع 'كورس'، بِع: الكورس ($497) + ملف Notion ($97) + جلسة فردية ($197) + مجموعة خاصة ($97) = قيمة إجمالية $888 — السعر فقط $297." },
        ],
    ...
    tools: [{ name: "Notion", url: "https://notion.so", desc: "لتنظيم بحث الجمهور والاعتراضات" }],
  },
  {
    id: "m2",
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "ما هو Lead Magnet الجيد؟", body: "هدية مجانية تحلّ مشكلة محددة جداً، تُستهلك في أقل من 10 دقائق، وتقود طبيعياً نحو منتجك المدفوع." },
          { heading: "أفضل 7 أنواع تعمل في 2026", body: "", bullets: ["PDF Cheat Sheet (صفحة واحدة، نقاط مرقّمة)","Notion Template جاهز للنسخ","Mini-Course بريدي 5 أيام","Webinar مسجّل 30 دقيقة","Audit مجاني (نموذج مكوّن من 10 أسئلة)","Toolkit / مجموعة موارد مُنسَّقة","حاسبة تفاعلية (ROI / Pricing)"] },
          { heading: "صيغة العنوان السحرية", body: "[الرقم] + [الفائدة المحددة] + [الإطار الزمني] + [بدون الألم]. مثال: 5 قوالب بريدية تضاعف معدل الفتح خلال أسبوع بدون نسخ من الإنترنت." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "قاعدة المسح البصري Z-Pattern", body: "العين العربية تقرأ من اليمين للأسفل ثم لليسار. ضع: الشعار يمين، Headline أعلى وسط، CTA يسار، Hero في الوسط، Social Proof تحته مباشرة." },
          { heading: "12 عنصر إلزامي", body: "راجع قالب صفحة الهبوط في تبويب الأدوات والقوالب لمعرفة الـ 12 عنصراً." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "مراحل القمع TOFU / MOFU / BOFU", body: "", bullets: ["TOFU: محتوى تعليمي مجاني (Reels، مدوّنات، Threads)","MOFU: Lead Magnet + سلسلة بريدية تربوية","BOFU: عرض محدود + Webinar / مكالمة + ضمان"] },
          { heading: "معدلات التحويل الصحية", body: "زائر → Lead: 2–5%. Lead → Sales call: 10–20%. Sales call → عميل: 20–40%. تحسين أي مرحلة 2x يضاعف إيرادك بدون زيادة الترافيك." },
        ],
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "تعريف عملي", body: "التسويق بالمحتوى هو إنتاج معرفة قيّمة مجاناً لجمهور محدد، بهدف بناء سلطة وثقة، تنتهي بتحويل القارئ إلى عميل عندما يصبح جاهزاً." },
          { heading: "لماذا الآن؟", body: "تكلفة الإعلانات ترتفع 25% سنوياً، بينما تكلفة المحتوى ثابتة بل يتراكم تأثيره (Compound Effect). كل قطعة محتوى ممتاز تستمر في جلب عملاء لسنوات." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "Hook — أوّل 3 ثواني", body: "إن لم تأسر الانتباه في 3 ثواني، خسرت الجمهور. صيغ ناجحة: 'لو عرفت هذا قبل 5 سنوات...' / 'الخطأ الذي يكلّفك آلاف الدولارات...' / 'فعلت هذا 30 يوم والنتيجة...'" },
          { heading: "Value — قدّم درساً واحداً", body: "قطعة محتوى = درس واحد فقط. لا تحاول قول كل شيء. كلما ضيّقت، عمَّقت، وزاد الحفظ والمشاركة." },
          { heading: "CTA — اطلب فعلاً واحداً", body: "احفظ / علّق بكلمة معينة / تابع للمزيد / حمّل الهدية. لا تخلط أكثر من CTA واحد." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "قاعدة 4-1-1", body: "من كل 6 منشورات: 4 تعليمية / ترفيهية، 1 قصة شخصية، 1 عرض. يحافظ على ثقة الجمهور بدون أن تتحوّل لـ Salesy." },
          { heading: "Batch Recording", body: "صوّر محتوى 4 أسابيع في يوم واحد. وفّر 80% من وقتك واحفظ جودة الإضاءة والإعداد ثابتة." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "صيغة الفيديو الناجح (15-30 ث)", body: "", bullets: ["Hook بصري + نصي في الثانية الأولى","Pattern Interrupt كل 3 ثواني (تغيير زاوية / Zoom / Text)","Payoff واضح في النهاية","Loop يعيد المشاهد للبداية (Watch Time أعلى)","Caption قصير يستفزّ التعليق"] },
          { heading: "Hashtags & Music", body: "استخدم 3-5 هاشتاج مزيج (Niche + متوسط + شائع). صوت Trending يضاعف الوصول 3x في أول 24 ساعة." },
        ],
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "الهرم الإعلاني", body: "كل منصة (Meta / Google / TikTok) تتبع نفس الهرم: حملة (الهدف) → مجموعة إعلانية (الجمهور والميزانية) → إعلان (الإبداع)." },
          { heading: "اختيار الهدف الصحيح", body: "", bullets: ["وعي بالعلامة → Awareness / Reach","زوار للموقع → Traffic","Leads → Lead Generation / Conversions","مبيعات → Sales / Conversions على حدث Purchase"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "مرحلة Testing (7 أيام)", body: "$20–50 يومياً لكل Ad Set، 3 إبداعات مختلفة، جمهور Broad. اقتل أي إبداع بـ CTR < 1% أو CPL > الهدف بـ 50%." },
          { heading: "مرحلة Scaling", body: "ضاعف ميزانية الفائز 20% كل 3 أيام (لا أكثر — يكسر الـ Learning). استنسخ الإعلان (Duplicate) لجماهير Lookalike مختلفة." },
        ],
  ...
  },
  {
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "قاعدة 5 ثواني", body: "اعرض صفحتك على شخص لـ 5 ثواني فقط، ثم اسأله: 'ما الذي يقدّمه هذا الموقع؟ ولمن؟'. إن لم يجب، أعد التصميم." },
          { heading: "تقليل Friction", body: "", bullets: ["نموذج بحقل واحد (البريد فقط) في المرحلة الأولى","إزالة كل القوائم العلوية (Distraction)","زر CTA واحد متكرر 3-5 مرات","زمن تحميل < 2.5 ثانية"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "إطار AIDA", body: "", bullets: ["Attention: Hook يكسر النمط","Interest: قصة أو إحصائية صادمة","Desire: اعرض النتيجة بعد المنتج","Action: CTA واضح + ضمان"] },
          { heading: "إطار PAS", body: "", bullets: ["Problem: صف الألم بكلمات العميل نفسها","Agitate: عمّق الألم — ماذا يحدث لو لم يحلّ؟","Solution: قدّم منتجك كحل واضح ومباشر"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "قواعد ذهبية للزر", body: "", bullets: ["نص بصيغة المتكلم: 'ابدأ تجربتي المجانية' بدلاً من 'ابدأ'","لون متباين عن خلفية الصفحة","حجم لا يقل عن 48px ارتفاعاً (Mobile-friendly)","Microcopy تحت الزر يقلّل القلق: 'لا حاجة لبطاقة ائتمان'"] },
        ],
    ...
    videos: [],
    templates: [TEMPLATES[0]],
    tools: [{ name: "Hotjar", url: "https://hotjar.com", desc: "خرائط حرارية لتحليل سلوك زوار الصفحة" }],
  },
  {
    id: "m6",
    slug: "email",
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "ملكيتك للقائمة", body: "السوشيال ميديا مستأجَرة (يمكن إغلاق حسابك غداً). قائمة بريدك ملكك للأبد، تنمو معك بتراكم." },
          { heading: "الأرقام الصحية", body: "", bullets: ["Open Rate: 25-35% جيد، 40%+ ممتاز","Click Rate: 3-7%","Unsubscribe: < 0.5% لكل حملة"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "البنية الزمنية", body: "", bullets: ["اليوم 0: ترحيب + تسليم الهدية","اليوم 1: قصتك الشخصية","اليوم 3: الدرس الأقوى لديك مجاناً","اليوم 5: دراسة حالة (Social Proof)","اليوم 7: العرض الأول (بدون ضغط)"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "Nurturing — رسالة أسبوعية", body: "محتوى تعليمي + ربط ذكي بمنتجك في النهاية. القاعدة: 80% قيمة، 20% بيع." },
          { heading: "Re-engagement", body: "كل 60 يوم، أرسل لمن لم يفتح: 'هل ما زلت معنا؟' — رسالة واحدة مع زر بسيط. من لا يتفاعل، احذفه (يحسّن Deliverability)." },
        ],
        apply: "أنشئ شريحة (Segment) للمشتركين غير النشطين خلال 60 يوم.",
      },
    ],
    videos: [{ id: ytId("https://www.youtube.com/watch?v=w-e8jb2GG2U"), title: "بناء سلاسل البريد الإلكتروني", summary: "شرح عملي لبناء سلاسل بريدية فعّالة من الصفر." }],
  ...
  },
  {
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "صيغة Brand Statement", body: "أنا [مهنتك] أساعد [جمهورك] على [تحقيق نتيجة] عبر [طريقتك الفريدة]. مثال: 'أنا مسوّق رقمي أساعد المدرّبين العرب على بناء قوائم بريدية مربحة عبر المحتوى المجاني.'" },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "نموذج 4 Content Pillars", body: "", bullets: ["ركيزة الخبرة: محتوى تعليمي عميق في مجالك","ركيزة القصة: تجاربك ودروسك الشخصية","ركيزة الرأي: مواقف جريئة تثير النقاش","ركيزة الإلهام: نتائج العملاء وقصص نجاحهم"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "الجدول اليومي (45 دقيقة)", body: "", bullets: ["15 دقيقة: نشر منشور / فيديو واحد","15 دقيقة: التعليق على 10 منشورات في مجالك","10 دقائق: الردّ على رسائل المتابعين","5 دقائق: تدوين فكرة محتوى للغد"] },
          { heading: "أسبوع بعد أسبوع", body: "", bullets: ["أسبوع 1: تثبيت الهوية البصرية والـ Bio","أسبوع 2: نشر 7 منشورات تعليمية","أسبوع 3: نشر 3 قصص شخصية + رأي جريء","أسبوع 4: إطلاق Lead Magnet أول"] },
        ],
    ...
    templates: [],
    tools: [{ name: "Canva", url: "https://canva.com", desc: "تصميم هوية بصرية متسقة" }],
  },
  {
    id: "m8",
    slug: "analytics",
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "المؤشرات الخمسة", body: "", bullets: ["CAC — تكلفة اكتساب عميل (Customer Acquisition Cost)","LTV — قيمة العميل مدى الحياة (Lifetime Value)","ROAS — العائد على الإنفاق الإعلاني","Conversion Rate — معدل التحويل في كل مرحلة","Churn Rate — معدل فقدان العملاء"] },
          { heading: "القاعدة الذهبية", body: "LTV ÷ CAC يجب أن يكون ≥ 3. إن كان أقل، فالنموذج غير مستدام مهما زاد الإنفاق." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "المعادلات", body: "", bullets: ["CAC = إجمالي الإنفاق التسويقي ÷ عدد العملاء الجدد","LTV = متوسط قيمة الطلب × عدد الطلبات السنوي × سنوات بقاء العميل","ROAS = الإيراد من الإعلان ÷ الإنفاق الإعلاني","Conversion Rate = (التحويلات ÷ الزوار) × 100","Churn Rate الشهري = (العملاء المفقودون ÷ العملاء بداية الشهر) × 100"] },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "مكونات Dashboard أسبوعية", body: "", bullets: ["صف 1 (الكبيرة): الإيراد، عدد العملاء الجدد، CAC، LTV","صف 2 (القنوات): الإيراد لكل قناة + ROAS","صف 3 (القمع): زوار → Leads → عملاء + معدلات التحويل","صف 4 (المحتوى): أفضل 5 منشورات أداءً","صف 5 (التحذيرات): أي KPI انحرف > 20% عن الهدف"] },
        ],
    ...
    lessons: [
      {
        ...
        sections: [
          { heading: "المحاور الستة", body: "", bullets: ["القنوات: أين يتواجدون وأيها الأقوى؟","المحتوى: ماذا ينشرون وما نوعية الـ Hooks؟","العروض: ما تركيبة المنتجات والأسعار؟","نقاط القوة: ماذا يفعلون أفضل منك؟","نقاط الضعف: شكاوى العملاء + ما يتجاهلونه","الفجوات: ما الفرص التي يمكنك سدّها؟"] },
          { heading: "أدوات سريعة", body: "Meta Ads Library (مجاناً) لمشاهدة كل إعلاناتهم. SimilarWeb لقياس حجم زوار موقعهم. SocialBlade لمتابعة نمو حساباتهم." },
        ],
      ...
      },
      {
        ...
        sections: [
          { heading: "محاور التمايز", body: "", bullets: ["تمايز بالجمهور: تخصّص في شريحة دقيقة جداً","تمايز بالطريقة: نهج فريد لحلّ نفس المشكلة","تمايز بالنبرة: شخصية صوت مميزة (جريء / علمي / دافئ)","تمايز بالسرعة: نتائج أسرع من المنافسين","تمايز بالضمان: ضمان لا يجرؤ غيرك على تقديمه"] },
          { heading: "Blue Ocean", body: "بدلاً من المنافسة في محيط أحمر، اصنع فئة جديدة. اسأل: ما الذي يفعله الجميع وأستطيع التوقف عن فعله؟ وما الذي لا يفعله أحد وأستطيع البدء فيه؟" },
        ],
...
export function getLessonById(id: string): { module: Module; lesson: Lesson } | undefined {
...
export function buildSearchIndex(): SearchHit[] {
  ...
  for (const m of MODULES) {
    hits.push({ type: "module", id: m.id, moduleId: m.id, moduleSlug: m.slug, moduleTitle: m.title, title: m.title, subtitle: m.subtitle });
    for (const l of m.lessons) {
      hits.push({ type: "lesson", id: l.id, moduleId: m.id, moduleSlug: m.slug, moduleTitle: m.title, title: l.title, subtitle: l.summary, body: l.sections.map((s) => s.heading + " " + s.body + " " + (s.bullets || []).join(" ")).join(" ") });
    }
    for (const v of m.videos) {
      hits.push({ type: "video", id: v.id, moduleId: m.id, moduleSlug: m.slug, moduleTitle: m.title, title: v.title, subtitle: v.summary, url: `https://www.youtube.com/watch?v=${v.id}` });
    }
    for (const t of m.templates) {
      hits.push({ type: "template", id: t.id, moduleId: m.id, moduleSlug: m.slug, moduleTitle: m.title, title: t.title, subtitle: t.desc });
    }
    for (const tool of m.tools) {
      hits.push({ type: "tool", id: tool.url, moduleId: m.id, moduleSlug: m.slug, moduleTitle: m.title, title: tool.name, subtitle: tool.desc, url: tool.url });
    }
  }
  for (const cs of CASE_STUDIES) {
    hits.push({ type: "case", id: cs.id, title: cs.title, subtitle: `قبل: ${cs.before} → بعد: ${cs.after}`, body: cs.strategy });
  }
  return hits;
}
